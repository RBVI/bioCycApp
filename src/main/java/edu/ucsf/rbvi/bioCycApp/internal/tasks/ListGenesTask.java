...
public class ListGenesTask extends AbstractTask implements ObservableTask {
	BioCycManager manager;
	List<Gene> geneList;

	@Tunable (description="Gene name", context="nogui")
	...
	public ListGenesTask (BioCycManager manager) {
	...
	public void run(TaskMonitor monitor) {
		...
		geneList = manager.getGenes(database, gene);
	}

  public <R> R getResults(Class<? extends R> type) {
		if (type.equals(String.class)) {
			return (R)geneList.toString();
		} else
			return (R)geneList;
  }
